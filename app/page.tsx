...
export default function Home() {
  return (
    ...
    >
      <div
        className="w-full mx-auto p-12 flex flex-col items-center justify-center min-h-[calc(100vh-48px)]"
        style={{
          backgroundColor: "#E7E5E3",
      ...
      >
        <div className="flex flex-col items-center gap-8">
          ...
          <Link
            href="/principles"
            className="text-xl font-medium text-gray-900 tracking-tight hover:opacity-70 transition-opacity"
          >
            Principles
          </Link>
        </div>
